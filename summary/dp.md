...
动态规划分类和例题：[leetcode book](https://leetcode-cn.com/leetbook/read/dynamic-programming-1-plus)
...
|分类|子分类|特点|例题|
| - | - | - | - |
| 线性动态规划 | | 按照问题规模 i 从小到大依次推过去的，<br>较大规模的问题的解依赖较小规模的问题的解 | |
| | 单串 | dp[i]的推导可能依赖于比i小的O(1)个子问题，<br>也可能依赖比i小的O(n)个子问题。 | 53. 最大子数组和<br>[300. 最长递增子序列](leetcode/300.最长递增子序列.md)<br>[673. 最长递增子序列的个数](./leetcode/673.最长递增子序列的个数.cpp)<br> |
